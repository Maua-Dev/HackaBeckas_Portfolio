...
class Test_DeleteSelfieController:
    ...
    def test_delete_order_controller_border_is_missing(self):
        repo = HackabeckasRepositoryMock()
        usecase = DeleteOrderUseCase(repo=repo)
        controller = DeleteOrderController(usecase=usecase)
        request = HttpRequest(
    ...
    def test_delete_order_controller_orderId_is_missing(self):
        repo = HackabeckasRepositoryMock()
        usecase = DeleteOrderUseCase(repo=repo)
        controller = DeleteOrderController(usecase=usecase)
        request = HttpRequest(
    ...
    def test_delete_order_controller_tableNumber_is_missing(self):
        repo = HackabeckasRepositoryMock()
        usecase = DeleteOrderUseCase(repo=repo)
        controller = DeleteOrderController(usecase=usecase)
        request = HttpRequest(
    ...
    def test_delete_order_controller_numberOfPeople_is_missing(self):
        repo = HackabeckasRepositoryMock()
        usecase = DeleteOrderUseCase(repo=repo)
        controller = DeleteOrderController(usecase=usecase)
        request = HttpRequest(
        ...
        response = controller(request=request)
        assert response.status_code == 400
    def test_delete_order_controller_flavor_is_missing(self):
        repo = HackabeckasRepositoryMock()
        usecase = DeleteOrderUseCase(repo=repo)
        controller = DeleteOrderController(usecase=usecase)
        request = HttpRequest(
    ...
    def test_delete_order_controller_orderId_not_decimal(self):
        repo = HackabeckasRepositoryMock()
        usecase = DeleteOrderUseCase(repo=repo)
        controller = DeleteOrderController(usecase=usecase)
        request = HttpRequest(
    ...
    def test_delete_order_controller_flavor_not_enum(self):
        repo = HackabeckasRepositoryMock()
        usecase = DeleteOrderUseCase(repo=repo)
        controller = DeleteOrderController(usecase=usecase)
        request = HttpRequest(
